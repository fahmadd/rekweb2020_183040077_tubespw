...
<div>
    ...
    <div class="nav-wrapper black">
      <ul class="">
      	...
      	<li class="right"><a href= "../tambah/tambah.php" class="waves-effect waves-light btn">Tambah FILM BARU?</a></li>
...
<div class="">
	<table border="1" cellspacing="0" cellpadding="10">
			...
			<td align="center"><?= $nama["No"]; ?></td>
					<td>	
							<a class ="waves-effect waves-light btn blue" href="../ubah/ubah.php?No=<?= $nama['No']; ?>">Ubah/Update</a>
							<a class="waves-effect waves-light btn red" href="../hapus/hapus.php?No=<?= $nama['No']; ?>" onclick ="return confirm('Anda Yakin ingin menghapus Film ini Dari Daftar?')">Hapus</a>
